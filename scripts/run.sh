...
# Run simulation
{
  ...
  if [[ "$EXTENSION" == "hepmc3.tree.root" ]]; then
    uncommon_flags=(
      ...
      --physics.alternativeStableStatuses $((SIGNAL_STATUS+1)) $((BG1_STATUS+1)) $((BG2_STATUS+1)) $((BG3_STATUS+1)) $((BG4_STATUS+1))
      --physics.alternativeDecayStatuses $((SIGNAL_STATUS+2)) $((BG1_STATUS+2)) $((BG2_STATUS+2)) $((BG3_STATUS+2)) $((BG4_STATUS+2))
